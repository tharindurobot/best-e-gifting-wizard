      ...
      <div className="container mx-auto px-[19px] py-[11px]">
        <div className="flex justify-between items-center">
          <Link to="/" className="flex items-center space-x-3 hover:opacity-80 transition-opacity">
            <img src="/lovable-uploads/5430729f-f06f-43cf-b98f-83a68ac00d9f.png" alt="BEST E Logo" className="w-12 h-12 rounded-full object-cover" />
            <div>
          ...
          <div className="flex items-center space-x-6">
            ...
            <Button onClick={handleWhatsAppClick} className="bg-green-600 hover:bg-green-700 text-white p-2 rounded-full" size="sm">
